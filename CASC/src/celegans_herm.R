...
g$source <- "https://github.com/ericmjonas/circuitdata/tree/master/celegans_herm" # Automatic discovery of cell types and microcircuitry from neuralconnectomics Eric Jonas and Konrad Kording, submitted
...
g$region <- "pharynx"
write.graph(g, "../graphs/c.elegans.herm_pharynx_1.graphml", format="graphml")
